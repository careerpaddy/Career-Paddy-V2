...
class _Quiz2WidgetState extends State<Quiz2Widget>
  ...
  void initState() {
    ...
    logFirebaseEvent('screen_view', parameters: {'screen_name': 'Quiz_2'});
    // On page load action.
    SchedulerBinding.instance.addPostFrameCallback((_) async {
      logFirebaseEvent('QUIZ_2_PAGE_Quiz_2_ON_INIT_STATE');
      logFirebaseEvent('Quiz_2_start_periodic_action');
  ...
  Widget build(BuildContext context) {
    ...
    return FutureBuilder<List<AppUsersRow>>(
      ...
      builder: (context, snapshot) {
        ...
        if (!snapshot.hasData) {
          return Scaffold(
            backgroundColor: FlutterFlowTheme.of(context).challenge3,
            body: Center(
              child: SizedBox(
                width: 45.0,
                height: 45.0,
        ...
        List<AppUsersRow> quiz2AppUsersRowList = snapshot.data!;

        final quiz2AppUsersRow =
            quiz2AppUsersRowList.isNotEmpty ? quiz2AppUsersRowList.first : null;
                          ...
                          Align(
                            ...
                            child: Container(
                              ...
                              decoration: BoxDecoration(
                                color: FlutterFlowTheme.of(context).challenge3,
                              ),
                              child: Padding(
                                    ...
                                    Row(
                                      ...
                                      children: [
                                        InkWell(
                                          ...
                                          onTap: () async {
                                            logFirebaseEvent(
                                                'QUIZ_2_PAGE_Icon_f4c19znh_ON_TAP');
                                            logFirebaseEvent(
                                                'Icon_navigate_to');
                                        ...
                                        Expanded(
                                          child: LinearPercentIndicator(
                                            ...
                                            progressColor: Color(0xFF8B26D3),
                                            backgroundColor: Color(0xFF441466),
                                            barRadius: Radius.circular(12.0),
                                            padding: EdgeInsets.zero,
                                          ),
                                        ),
                                        if (quiz2AppUsersRow?.plan !=
                                            'Fun Learning Plan')
                                          Row(
                                            mainAxisSize: MainAxisSize.max,
                                            children: [
                                                      ...
                                                      return ListView.separated(
                                                        ...
                                                        itemBuilder: (context,
                                                          ...
                                                          return InkWell(
                                                            ...
                                                            onTap: () async {
                                                              logFirebaseEvent(
                                                                  'QUIZ_2_PAGE_Container_qifjorro_ON_TAP');
                                                              logFirebaseEvent(
