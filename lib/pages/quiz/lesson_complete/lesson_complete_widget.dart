                        ...
                        Container(
                          ...
                          child: Builder(
                            builder: (context) => FFButtonWidget(
                              onPressed: () async {
                                logFirebaseEvent(
                                    'LESSON_COMPLETE_DOWNLOAD_BADGE_BTN_ON_TA');
                                ...
                                if ((_model.apiResult3lc?.succeeded ?? true)) {
                                  logFirebaseEvent('Button_launch_u_r_l');
                                  await launchURL(DownloadBadgeCall.url(
                                    (_model.apiResult3lc?.jsonBody ?? ''),
                                  )!);
                                } else {
