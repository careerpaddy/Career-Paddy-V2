...
class _QuotesWidgetState extends State<QuotesWidget> {
  ...
  void initState() {
    ...
    SchedulerBinding.instance.addPostFrameCallback((_) async {
      logFirebaseEvent('QUOTES_PAGE_Quotes_ON_INIT_STATE');
      if (widget!.isEdit) {
        logFirebaseEvent('Quotes_update_page_state');
              ...
              children: [
                Text(
                  FFLocalizations.of(context).getText(
                    'f553e8w8' /* Do you agree with the statemen... */,
                  ),
                        ...
                        child: Padding(
                          ...
                          child: Column(
                            ...
                            children: [
                              Text(
                                FFLocalizations.of(context).getText(
                                  '85ca2jz6' /* Soft skills are needed across ... */,
                                ),
                ...
                Row(
                  ...
                  children: [
                    InkWell(
                      ...
                      onTap: () async {
                        logFirebaseEvent('QUOTES_PAGE_options_ON_TAP');
