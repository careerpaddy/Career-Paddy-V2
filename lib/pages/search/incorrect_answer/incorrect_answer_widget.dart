...
import 'incorrect_answer_model.dart';
export 'incorrect_answer_model.dart';

class IncorrectAnswerWidget extends StatefulWidget {
  ...
  @override
  State<IncorrectAnswerWidget> createState() => _IncorrectAnswerWidgetState();
}

class _IncorrectAnswerWidgetState extends State<IncorrectAnswerWidget> {
  late IncorrectAnswerModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => IncorrectAnswerModel());
  }
            ...
            Container(
              ...
              child: Builder(
                builder: (context) => FFButtonWidget(
                  onPressed: () async {
                    logFirebaseEvent('INCORRECT_ANSWER_OK_GOT_IT_BTN_ON_TAP');
