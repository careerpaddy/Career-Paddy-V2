  ...
  try {
    ...
    switch (paramType) {
      ...
      case ParamType.SupabaseRow:
        ...
        switch (T) {
          case CompletedRow:
            return CompletedRow(data);
          case LearningPointsLogRow:
            return LearningPointsLogRow(data);
          case RatingsRow:
            return RatingsRow(data);
          case QuestionBatchRow:
            return QuestionBatchRow(data);
          case MessagesRow:
          ...
          case ModuleBatchProgressRow:
            return ModuleBatchProgressRow(data);
          case ChatsRow:
            return ChatsRow(data);
          case OptionsRow:
            return OptionsRow(data);
          case UserLessonsRow:
            return UserLessonsRow(data);
          case LessonsRow:
            return LessonsRow(data);
          case AnsweredQuestionsRow:
            return AnsweredQuestionsRow(data);
          case QuestionsRow:
            return QuestionsRow(data);
          case HighestScorerRow:
            return HighestScorerRow(data);
          case SubscriptionsRow:
            return SubscriptionsRow(data);
          case QuestionBatchTensRow:
            return QuestionBatchTensRow(data);
          case BookingsRow:
            return BookingsRow(data);
          case FailedQuestionsRow:
            return FailedQuestionsRow(data);
          default:
            return null;
        }
